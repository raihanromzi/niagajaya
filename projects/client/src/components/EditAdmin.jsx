...
import { Flex, Button, Box, Modal, ModalOverlay, ModalContent, ModalHeader, ModalBody, useDisclosure, FormControl, FormLabel, Input, IconButton, Center } from "@chakra-ui/react";
            ...
            <Form>
              <FormControl>
                ...
                <Center paddingTop={"10px"} gap={"10px"} mt={10}>
                  ...
                  <Button variant="outline" color="#009262" borderColor="#009262" mr={5} onClick={close}>
                    Batal
                  </Button>
                </Center>
              </FormControl>
